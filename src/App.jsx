...
const App = () => {
  ...
  // fetchQuote()
  return (
    <div className=' h-[100vh] flex justify-center items-center bg-[url("https://t4.ftcdn.net/jpg/03/98/29/37/360_F_398293720_XOwzFWNaEG23Nm7ipWeKKWnwB7f5vImI.jpg")] bg-no-repeat bg-cover'>
